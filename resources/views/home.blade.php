...
<body>
  <section class="w-full px-3 antialiased bg-indigo-600 lg:px-6 h-screen" data-primary="indigo-600"
      ...
      <nav class="flex items-center w-full h-24 select-none" x-data="{ showMenu: false }">
        <div
          ...
          <a href="#_" class="w-1/4 py-4 pl-6 pr-4 md:pl-4 md:py-0">
            <span class="p-1 text-xl font-black leading-none text-white select-none"><span class="">Linky</span><span
                class="text-indigo-300" data-primary="indigo-300">.</span></span>
          </a>
          <div
            ...
            <div
              ...
              <div
                ...
                <a href="#"
                  ...
                  data-primary="indigo-700">Home</a>
                <a href="#"
                  ...
                  data-primary="indigo-800">Features</a>
                <a href="#"
                  class="inline-block px-0 px-4 py-2 mx-2 font-medium text-left md:px-0 hover:text-indigo-800 md:hover:text-white lg:mx-3 md:text-center"
                  data-primary="indigo-800">Blog</a>
                <a href="#"
                  class="inline-block px-0 px-4 py-2 mx-2 font-medium text-left md:px-0 hover:text-indigo-800 md:hover:text-white lg:mx-3 md:text-center"
                  data-primary="indigo-800">Contact</a>
              </div>
              <div class="flex flex-col items-center justify-end w-full h-full pt-4 md:w-1/3 md:flex-row md:py-0">
                <a href="#_" class="w-full pl-6 mr-0 text-indigo-200 hover:text-white md:pl-0 md:mr-3 lg:mr-5 md:w-auto"
                  data-primary="indigo-600">Sign In</a>
                <a data-rounded="rounded-full" href="#_"
                  ...
                  data-primary="indigo-600">Sign Up</a>
              </div>
            </div>
          </div>
